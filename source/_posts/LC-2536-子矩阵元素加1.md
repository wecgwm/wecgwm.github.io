...
为了方便，初始化差分数组大小为 $[n + 2][n + 2]$，其中一次加 $1$ 是为了避免特判差分修正时的下标溢出；另一次加 $1$ 是为了避免特判做 [二位前缀和](https://oi-wiki.org/basic/prefix-sum/#%E4%BA%8C%E7%BB%B4%E5%A4%9A%E7%BB%B4%E5%89%8D%E7%BC%80%E5%92%8C) 时下标为负数的情况。
